...
export LOCAL_REGISTRY_HOST=<host>
export LOCAL_REGISTRY_PORT=<port>
export LOCAL_REGISTRY=${LOCAL_REGISTRY_HOST}:${LOCAL_REGISTRY_PORT}
export LOCAL_REGISTRY_REPO=${LOCAL_REGISTRY}/<repo>
export LOCAL_REGISTRY_USER=<username>
export LOCAL_REGISTRY_PASS=<password>
